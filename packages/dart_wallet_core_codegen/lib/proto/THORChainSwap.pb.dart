...
class SwapOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set bitcoin($6.SigningInput v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set ethereum($7.SigningInput v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set binance($11.SigningInput v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set cosmos($8.SigningInput v) { $_setField(7, v); }
  @$pb.TagNumber(7)
