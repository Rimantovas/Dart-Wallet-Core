...
class Message extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set bridgeTransferOut(Message_BridgeTransferOut v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set encodingMode(EncodingMode v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set signingMode(SigningMode v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(11)
  set mode(BroadcastMode v) { $_setField(11, v); }
  @$pb.TagNumber(11)
