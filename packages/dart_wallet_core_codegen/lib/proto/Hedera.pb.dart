...
class TransactionID extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set transactionValidStart(Timestamp v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class TransactionBody extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set transactionID(TransactionID v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(6)
  set transfer(TransferMessage v) { $_setField(6, v); }
  @$pb.TagNumber(6)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set body(TransactionBody v) { $_setField(2, v); }
  @$pb.TagNumber(2)
