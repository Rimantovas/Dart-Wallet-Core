...
static String signMessage(PrivateKey privateKey, String message) {
    ...
    var result = WalletCore.wcb.TWStarkExMessageSignerSignMessage(privateKey0,message0);
...
static bool verifyMessage(PublicKey pubKey, String message, String signature) {
    ...
    var result = WalletCore.wcb.TWStarkExMessageSignerVerifyMessage(pubKey0,message0,signature0);
    deferManager.runDeferredActions();
    return result;
}
