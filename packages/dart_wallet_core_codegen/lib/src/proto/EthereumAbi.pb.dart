...
class ArrayType extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set elementType(ParamType v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class FixedArrayType extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set elementType(ParamType v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class Param extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set param(ParamType v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class ParamType extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set boolean(BoolType v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set numberInt(NumberNType v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set numberUint(NumberNType v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set stringParam(StringType v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set address(AddressType v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set byteArray(ByteArrayType v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set byteArrayFix(ByteArrayFixType v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(14)
  set array(ArrayType v) { $_setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set fixedArray(FixedArrayType v) { $_setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(19)
  set tuple(TupleType v) { $_setField(19, v); }
  @$pb.TagNumber(19)
...
class Token extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set numberInt(NumberNParam v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set numberUint(NumberNParam v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(14)
  set array(ArrayParam v) { $_setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set fixedArray(ArrayParam v) { $_setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(19)
  set tuple(TupleParam v) { $_setField(19, v); }
  @$pb.TagNumber(19)
...
class ContractCallDecodingOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set error(AbiError v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class ParamsDecodingInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set abiParams(AbiParams v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class ParamsDecodingOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set error(AbiError v) { $_setField(2, v); }
  @$pb.TagNumber(2)
