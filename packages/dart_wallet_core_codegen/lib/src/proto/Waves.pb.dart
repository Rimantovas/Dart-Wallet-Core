...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set transferMessage(TransferMessage v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set leaseMessage(LeaseMessage v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set cancelLeaseMessage(CancelLeaseMessage v) { $_setField(5, v); }
  @$pb.TagNumber(5)
