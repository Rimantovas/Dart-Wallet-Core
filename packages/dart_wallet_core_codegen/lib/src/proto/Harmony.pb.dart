...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set transactionMessage(TransactionMessage v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set stakingMessage(StakingMessage v) { $_setField(4, v); }
  @$pb.TagNumber(4)
...
class StakingMessage extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set createValidatorMessage(DirectiveCreateValidator v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set editValidatorMessage(DirectiveEditValidator v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set delegateMessage(DirectiveDelegate v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set undelegateMessage(DirectiveUndelegate v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set collectRewards(DirectiveCollectRewards v) { $_setField(5, v); }
  @$pb.TagNumber(5)
...
class CommissionRate extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set rate(Decimal v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set maxRate(Decimal v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set maxChangeRate(Decimal v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class DirectiveCreateValidator extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set description(Description v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set commissionRates(CommissionRate v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class DirectiveEditValidator extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set commissionRate(Decimal v) { $_setField(3, v); }
  @$pb.TagNumber(3)
