...
class CellDep extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set outPoint(OutPoint v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class CellOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set lock(Script v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set type(Script v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class DaoWithdrawPhase1 extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set depositCell(Cell v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class DaoWithdrawPhase2 extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set withdrawingCell(Cell v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set plan(TransactionPlan v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set nativeTransfer(NativeTransfer v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set sudtTransfer(SudtTransfer v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set daoDeposit(DaoDeposit v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set daoWithdrawPhase1(DaoWithdrawPhase1 v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set daoWithdrawPhase2(DaoWithdrawPhase2 v) { $_setField(9, v); }
  @$pb.TagNumber(9)
...
class Cell extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set lock(Script v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set type(Script v) { $_setField(4, v); }
  @$pb.TagNumber(4)
