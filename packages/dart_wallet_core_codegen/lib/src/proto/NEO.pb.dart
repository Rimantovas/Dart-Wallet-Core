...
class Transaction extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set nep5Transfer(Transaction_Nep5Transfer v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set invocationGeneric(Transaction_InvocationGeneric v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set plan(TransactionPlan v) { $_setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set transaction(Transaction v) { $_setField(8, v); }
  @$pb.TagNumber(8)
