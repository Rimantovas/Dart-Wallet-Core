...
class SigningInput extends $pb.GeneratedMessage {
  factory SigningInput({
    ...
    if (scripts != null) {
      $result.scripts.addEntries(scripts);
    }
    if (utxo != null) {
  ...
  @$pb.TagNumber(21)
  $1.SigningInput get signingV2 => $_getN(18);
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(21)
  $1.SigningInput ensureSigningV2() => $_ensure(18);
...
class PreSigningOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set preSigningResultV2($1.PreSigningOutput v) { $_setField(7, v); }
  @$pb.TagNumber(7)
