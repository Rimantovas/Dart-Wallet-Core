...
class Staking_BondAndNominate extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  set bondCallIndices(CallIndices v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set nominateCallIndices(CallIndices v) { $_setField(7, v); }
  @$pb.TagNumber(7)
...
class Staking_ChillAndUnbond extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set chillCallIndices(CallIndices v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set unbondCallIndices(CallIndices v) { $_setField(4, v); }
  @$pb.TagNumber(4)
