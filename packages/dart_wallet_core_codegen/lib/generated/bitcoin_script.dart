...
class BitcoinScript {
  ...
  bool operator ==(Object other) {
    ...
    return other is BitcoinScript &&
        WalletCore.wcb.TWBitcoinScriptEqual(rawValue, other.rawValue);
  }
  ...
  static BitcoinScript createWithBytes(Uint8List bytes, int size) {
    final deferManager = DeferManager();
    var data0 = TWDataCreateWithNSData(bytes);
    deferManager.defer(() {
      WalletCore.wcb.TWDataDelete(data0);
    });
    var result = WalletCore.wcb
        .TWBitcoinScriptCreateWithBytes(data0.cast<Uint8>(), size);
  ...
  Uint8List? matchPayToWitnessPublicKeyHash() {
    ...
    var obj = rawValue;
    var result =
        WalletCore.wcb.TWBitcoinScriptMatchPayToWitnessPublicKeyHash(obj);
    if (result.address == nullptr.address) {
      deferManager.runDeferredActions();
      return null;
    }
  ...
  static BitcoinScript buildPayToScriptHash(Uint8List scriptHash) {
    ...
    var result =
        WalletCore.wcb.TWBitcoinScriptBuildPayToScriptHash(scriptHash0);
    deferManager.runDeferredActions();
    return BitcoinScript(result);
  }
  ...
  static BitcoinScript buildPayToWitnessPubkeyHash(Uint8List hash) {
    ...
    var result =
        WalletCore.wcb.TWBitcoinScriptBuildPayToWitnessPubkeyHash(hash0);
    deferManager.runDeferredActions();
    return BitcoinScript(result);
  }
  ...
  static BitcoinScript buildPayToWitnessScriptHash(Uint8List scriptHash) {
    ...
    var result =
        WalletCore.wcb.TWBitcoinScriptBuildPayToWitnessScriptHash(scriptHash0);
    deferManager.runDeferredActions();
    return BitcoinScript(result);
  }
  ...
  static BitcoinScript lockScriptForAddress(String address, CoinType coin) {
    ...
    var result =
        WalletCore.wcb.TWBitcoinScriptLockScriptForAddress(address0, coin0);
    deferManager.runDeferredActions();
    return BitcoinScript(result);
  }

  static BitcoinScript lockScriptForAddressReplay(
      String address, CoinType coin, Uint8List blockHash, int blockHeight) {
    final deferManager = DeferManager();
    var address0 = TWStringCreateWithNSString(address);
    deferManager.defer(() {
      WalletCore.wcb.TWStringDelete(address0);
    ...
    var result = WalletCore.wcb.TWBitcoinScriptLockScriptForAddressReplay(
        address0, coin0, blockHash0, blockHeight);
    deferManager.runDeferredActions();
    return BitcoinScript(result);
  }
  ...
  bool get isPayToWitnessScriptHash {
    final deferManager = DeferManager();
    var result =
        WalletCore.wcb.TWBitcoinScriptIsPayToWitnessScriptHash(rawValue);
    deferManager.runDeferredActions();
    return result;
  }
  ...
  bool get isPayToWitnessPublicKeyHash {
    final deferManager = DeferManager();
    var result =
        WalletCore.wcb.TWBitcoinScriptIsPayToWitnessPublicKeyHash(rawValue);
    deferManager.runDeferredActions();
    return result;
  }
