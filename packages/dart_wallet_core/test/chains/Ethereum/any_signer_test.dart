...
void main() {
  ...
  group('TWEthereumSigner', () {
    ...
    test('SignERC20TransferAsERC20', () {
      final chainId = 1.serialize;
      final nonce = 0.serialize;
      final gasPrice = 42000000000.serialize; // 0x09c7652400
      final gasLimit = 78009.serialize; // 130B9
      const toAddress = "0x5322b34c88ed0691971bf52a7047448f0f4efc84";
      const token = "0x6b175474e89094c44da98b954eedeac495271d0f"; // DAI
      final amount = BigInt.parse('2000000000000000000').serialize;
      final key =
