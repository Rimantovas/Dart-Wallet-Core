...
void main() {
  ...
  group('TWEthereumSigner', () {
    ...
    test('Sign', () {
      ...
      final chainId = 1.toByteArray();
      final nonce = 11.toByteArray();
      final gasPrice = 20000000000.toByteArray();
      final gasLimit = 1000000.toByteArray();
      final data =
    ...
    test('SignERC20TransferAsERC20', () {
      final chainId = 1.toByteArray();
      final nonce = 0.toByteArray();
      final gasPrice = 42000000000.toByteArray(); // 0x09c7652400
      final gasLimit = 78009.toByteArray(); // 130B9
      const toAddress = "0x5322b34c88ed0691971bf52a7047448f0f4efc84";
      const token = "0x6b175474e89094c44da98b954eedeac495271d0f"; // DAI
      final amount = BigInt.parse('2000000000000000000').toBytes();
      final key =
      ...
      final function = EthereumAbiFunction.createWithString('transfer')
        ..addParamAddress(toAddress.hexToBytes(), false)
        ..addParamUInt256(amount, false);

      payload = EthereumAbi.encode(function);
    ...
    //   // sign test
    //   final output = Ethereum.SigningOutput.fromBuffer(
    //       AnySigner.sign(input.writeToBuffer(), coin));
    ...
    //   Uint8List payload;
    //   {
    //     final func = EthereumAbiFunction('safeTransferFrom')
    ...
    //   final result = AnySigner.signJSON(json: jsonStr, key: key, coin: coin);

    //   expect(AnySigner.supportsJSON(coin), true);
    //   expect(result,
    ...
    //   final outputTWData = AnySigner.plan(inputData, coin);
    ...
    //   Uint8List payload;
    //   {
    //     final func = EthereumAbiFunction('deposit');
    //     payload = func.encode();
    //   }
    ...
    //   Uint8List payload;
    //   {
    //     final func = EthereumAbiFunction('burn')
