...
void main() {
  ...
  group('AnyAddress', () {
    ...
    test('SmartBitcoinCash address data', () {
      const string = '0x4E5B2e1dc63F6b91cb6Cd759936495434C7e972F';
      final addr =
    ...
    test('KuCoin Community Chain address data', () {
      const string = '0x4E5B2e1dc63F6b91cb6Cd759936495434C7e972F';
      final addr =
    ...
    test('Bitcoin segwit address data', () {
    ...
    test('Bitcoin taproot address data', () {
      const string =
